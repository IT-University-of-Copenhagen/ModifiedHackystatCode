...
*/
	 ...
	 *             that cannot be marshalled into Java SensorDataIndex instance.
	 */
	public synchronized String getSensorDataIndexLastMod(String email,
...
*/
	...
	public synchronized boolean storeUser(User user, String xmlUser,
	...
	public synchronized String getProject(User owner, String projectName)
			throws SensorBaseClientException {
		String xmlData = "";
		String ownerXml = "";
	...
	// Nan
	public synchronized boolean storeSensorData(SensorData n1, String n2, String n3)
			throws SensorBaseClientException {
		String temp = "";
		try {
