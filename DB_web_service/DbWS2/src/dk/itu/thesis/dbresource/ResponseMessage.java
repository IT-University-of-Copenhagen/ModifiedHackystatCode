...
public class ResponseMessage {
   ...
   */
   static String adminOnly(DBaseResource resource) {
   ...
   * @return A string describing the problem.
   */
  static String adminOrAuthUserOnly(DBaseResource resource, String authUser, 
      String uriUser) {
   ...
   * @return A string describing the problem.
   */
  static String internalError(DBaseResource resource, Logger logger, Exception e) {
   ...
   * @return A string describing the problem.
   */
   static String miscError(DBaseResource resource, String message) {
   ...
   * @return A string describing the problem.
   */
  static String undefinedUser(DBaseResource resource, String user) {
   ...
   * @return A string describing the problem.
   */
  static String undefinedProject(DBaseResource resource, User user, String project) {
   ...
   * @return A string describing the problem.
   */
  static String cannotViewProject(DBaseResource resource, String user, String project) {
   ...
   * @return A string describing the problem.
   */
  static String notProjectOwner(DBaseResource resource, String user, String project) {
   ...
   * @return A string describing the problem.
   */
  static String badTimestamp(DBaseResource resource, String timestamp) {
