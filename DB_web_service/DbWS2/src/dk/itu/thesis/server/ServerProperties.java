...
public class ServerProperties {
  ...
  /** The admin email key. */
  public static final String ADMIN_EMAIL_KEY =     "dbWS.admin.email";
  /** The admin password. */
  public static final String ADMIN_PASSWORD_KEY =   "dbWS.admin.password";
  /** The context root key. */
  public static final String CONTEXT_ROOT_KEY =    "dbWS.context.root";
  /** The database directory key. */
  public static final String DB_DIR_KEY =          "dbWS.db.dir";
  /** The database implementation class. */
  public static final String DB_IMPL_KEY =          "dbWS.db.impl";
  /** The hostname key. */
  public static final String HOSTNAME_KEY =        "dbWS.hostname";
  /** The logging level key. */
  public static final String LOGGING_LEVEL_KEY =   "dbWS.logging.level";
  /** The Restlet Logging key. */
  public static final String RESTLET_LOGGING_KEY = "dbWS.restlet.logging";
  /** The SMTP host key. */
  public static final String SMTP_HOST_KEY =       "dbWS.smtp.host";
  /** The sensorbase port key. */
  public static final String PORT_KEY =            "dbWS.port";
  /** The XML directory key. */
  public static final String XML_DIR_KEY =         "dbWS.xml.dir";
  /** The test installation key. */
  public static final String TEST_INSTALL_KEY =    "dbWS.test.install";
  /** The test domain key. */
  public static final String TEST_DOMAIN_KEY =     "dbWS.test.domain";
  /** The sensorbase port key during testing. */
  public static final String TEST_PORT_KEY =       "dbWS.test.port";
  /** The sensorbase db dir during testing. */
  public static final String TEST_DB_DIR_KEY =       "dbWS.test.db.dir";
  /** The test admin email key. */
  public static final String TEST_ADMIN_EMAIL_KEY =     "dbWS.test.admin.email";
  /** The test admin password. */
  public static final String TEST_ADMIN_PASSWORD_KEY =   "dbWS.test.admin.password";  
  /** The test hostname. */
  public static final String TEST_HOSTNAME_KEY =   "dbWS.test.hostname";  
  /** Whether to compress on startup. */
  public static final String COMPRESS_ON_STARTUP_KEY =   "dbWS.db.startup.compress";  
  /** Whether to re-index on startup. */
  public static final String REINDEX_ON_STARTUP_KEY =   "dbWS.db.startup.reindex";  
  /** SMTP Server User name. */
  public static final String SMTP_SERVER_USER =     "dbWS.smtp.user";
  /** The admin email key. */
  public static final String SMTP_SERVER_PASS =     "dbWS.smtp.pass";
  ...
  private void initializeProperties () throws Exception {
    ...
    String propFile = userHome + "/.hackystat/sensorbase/dbWS.properties";
    ...
    properties.setProperty(CONTEXT_ROOT_KEY, "dbWS");
    properties.setProperty(DB_DIR_KEY, sensorBaseHome + "/db");
    properties.setProperty(DB_IMPL_KEY, "dk.itu.thesis.derbyImp.DerbyImplementation");
    ...
    properties.setProperty(TEST_PORT_KEY, "8282");
    ...
    try {
      ...
      System.out.println("Loading Database Web Service properties from: " + propFile);
    }
    catch (IOException e) {
